...
<meta charset="UTF-8">
<title>委域評分活動使用scoreActivity.jsp</title>
    ...
    <header class="masthead" style="background-image: url('<%=request.getContextPath()%>/asset/img/activity01.jpg')">
   	...
   	<div style="border: 2px white groove; width: 70%; margin: 0 auto 60px auto;">
		...
		<h2>進來評分活動囉!</h2>
			...
			<label class="formLabel" for="comment">評論內容: <span style="color: red">${errorMsgs.comment}</span></label>
			<textarea class="actFormInput actContentFormInput" cols="55" name="comment"><%= (actaVO == null) ? 
					"空想食境Fantasy MEALity 為 Manga'Z 所打造出的獨特餐飲體驗，將餐飲結合虛擬實境，用120分鐘的時間帶消費者走入空想王國體驗超乎想像的美食饗宴。" 
																			 :actaVO.getComment() %></textarea>	
