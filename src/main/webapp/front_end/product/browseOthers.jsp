...
<%
	...
	List<ProductVO> list = productService.getProductsByType(0);
		...
		<div class="row">
			...
			<div class="col-12 col-md-3 list-group">
				<FORM METHOD="post" ACTION="product/ProductServlet">
				  <a href="<%=request.getContextPath() %>/front_end/product/homePage.jsp" class="list-group-item list-group-item-action" aria-current="true">
				    總覽
				  </a>
				  ...
				  <a href="<%=request.getContextPath() %>/front_end/product/browseOthers.jsp" class="list-group-item list-group-item-action active">其他</a>
