            ...
            <%@ page import="java.util.*" %>
                ...
                <% NewsVO newsVO=(NewsVO) request.getAttribute("newsVO");%>
                    ...
                    <head>
                        ...
                        <link href="<%=request.getContextPath()%>/vendor/datatables/dataTables.bootstrap4.min.css"
                            rel="stylesheet">
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="type" size="45"
                                                                value="${newsVO.type}" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td>標題:</td>
                                                        <td><input type="text" name="title" size="45"
                                                                value="${newsVO.title}" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td>內文:</td>
                                                        <td><input type="text" name="content" size="45"
                                                                value="${newsVO.content}" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td>建立日期:</td>
                                                        <td><input type="datetime-local" name="date" size="45"
                                                                value="${newsVO.date}" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td>圖片:</td>
                                                        <td><input type="file" name="image" size="45"
                                                                value="${newsVO.image}" /></td>
                                                    </tr>
                                                </table>
                                                <br>
