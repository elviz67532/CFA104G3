...
<ul
	...
	<li class="nav-item"><a class="nav-link collapsed" href="#"
		...
		aria-expanded="true" aria-controls="collapseProduct"> <i
			class="fas fa-fw fa-cog"></i> <span>二手買賣</span>
	</a>
		<div id="collapseProduct" class="collapse"
			...
			<div class="bg-white py-2 collapse-inner rounded">
				<a class="collapse-item"
					...
					class="collapse-item"
					href="/CFA104G3/back_end/product/seller.jsp">商品管理</a> <a
					class="collapse-item"
	...
	<li class="nav-item"><a class="nav-link collapsed" href="#"
		data-toggle="collapse" data-target="#collapseMove"
		aria-expanded="true" aria-controls="collapseMove"> <i
			class="fas fa-fw fa-cog"></i> <span>搬家</span>
	</a>
		<div id="collapseMove" class="collapse" aria-labelledby="headingTwo"
			data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				<a class="collapse-item"
					href="<%=request.getContextPath()%>/back_end/move/moveRequestManage.jsp">申請單管理</a>
				<a class="collapse-item"
					href="<%=request.getContextPath()%>/back_end/move/readMoveOrder.jsp">訂單管理</a>
			</div>
		</div></li>
	...
	<li class="nav-item"><a class="nav-link collapsed" href="#"
		...
		aria-expanded="true" aria-controls="collapseMember"> <i
			class="fas fa-fw fa-cog"></i> <span>會員</span>
	</a>
	...
	<li class="nav-item"><a class="nav-link collapsed"
		...
		<div id="collapseManager" class="collapse"
			...
			<div class="bg-white py-2 collapse-inner rounded">
				<a class="collapse-item"
					href="/CFA104G3/back_end/server_manager/admin.jsp">權限管理</a> <a
					class="collapse-item"
					href="/CFA104G3/back_end/server_manager/addManager.jsp">新增管理員</a>
			</div>
		</div></li>
