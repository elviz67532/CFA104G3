...
<nav
	...
	<ul class="navbar-nav ml-auto">
		...
		<li class="nav-item dropdown no-arrow"><a
			...
			<img class="img-profile rounded-circle" src="<%=request.getContextPath()%>/asset/img/undraw_profile.svg">
		</a> <!-- Dropdown - User Information -->
			<div
				class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
				aria-labelledby="userDropdown">
				<a class="dropdown-item" href="<%=request.getContextPath()%>/back_end/server_manager/profile.jsp"> <i
