...
<!--                             </ul> -->
                    ...
                    <div style = "display: inline-block; ">
                       <label class="formLabel" for="name">輸入商品編號: <span style="color: red">${errorMsgs}</span></label><br>
                       <input type="text" name="k2">
                    </div>
                    <div style = "display: inline-block; margin-left:99px;">
                       <label class="formLabel" for="name">輸入會員編號: <span style="color: red">${errorMsgs}</span></label><br>                          
                       <input type="text" name="k1">
                    </div>
                       <input type="hidden" name="action" value="getOne_For_Display">
                       <input type="submit" style="margin-left:4px;" value="送出" class="btn btn-outline-primary">
                    </FORM>                    
...
<%-- 							src="<%=request.getContextPath()%>/asset/img/undraw_profile_1.svg" --%>
<!-- 							alt="..."> -->
...
<!-- 					<div class="dropdown-list-image mr-3"> -->
<!-- 						<img class="rounded-circle" -->
<%-- 							src="<%=request.getContextPath()%>/asset/img/undraw_profile_2.svg" --%>
<!-- 							alt="..."> -->
...
<!-- 					<div class="dropdown-list-image mr-3"> -->
<!-- 						<img class="rounded-circle" -->
<%-- 							src="<%=request.getContextPath()%>/asset/img/undraw_profile_3.svg" --%>
<!-- 							alt="..."> -->
...
<!-- 			</div></li> -->
		...
		<li class="nav-item dropdown no-arrow">
			<a class="nav-link dropdown-toggle" href="#" id="userDropdown"
				role="button" data-toggle="dropdown" aria-haspopup="true"
				aria-expanded="false"> 
				<span class="mr-2 d-none d-lg-inline text-gray-600 small">${sessionScope.account}</span> 
				<img class="img-profile rounded-circle"
					src="<%=request.getContextPath()%>/asset/img/undraw_profile.svg">
